  ...
  imports: [
    ...
    TypeOrmModule.forRootAsync({
      ...
      useFactory: (configService: ConfigService) => ({
        ...
        username: configService.get('DATABASE_USERNAME', 'homie_user'),
        password: configService.get('DATABASE_PASSWORD', 'homie_password'),
        database: configService.get('DATABASE_NAME', 'homie_dev'),
